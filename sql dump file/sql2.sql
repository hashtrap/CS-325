...
CREATE TABLE Hotels (
    ...
    suitoptions VARCHAR(255) NOT NULL,
    username VARCHAR(50) NOT NULL,
    PRIMARY KEY (name)
);

-- Insert sample data into Hotels table
INSERT INTO Hotels (name, location, suitoptions, username) VALUES
('Grand Paris Hotel', 'Paris, France', 'Single, Double, Suite', 'jdoe'),
('Bali Beach Resort', 'Bali, Indonesia', 'Standard, Deluxe, Villa', 'asmith'),
('Tokyo Central Inn', 'Tokyo, Japan', 'Single, Double, Family Suite', 'bwilliams'),
('Sydney Harbour Hotel', 'Sydney, Australia', 'Suite, Executive Suite, Penthouse', 'ckent'),
('Cape Town Lodge', 'Cape Town, South Africa', 'Standard, Deluxe, Family Suite', 'dwayne');